...
const schema = z.object({
  ...
  proofDrivingLicense: z.boolean().default(false),
  proofVoterCard: z.boolean().default(false),
  proofPassport: z.boolean().default(false),
  proofTenthCertificate: z.boolean().default(false),
  proofAadhaarCard: z.boolean().default(false),
  proofDeliverInShop: z.boolean().default(false),
  proofAffidavitDob: z.boolean().default(false),
  proofNotaryTest: z.boolean().default(false),
  proofBirthCertificate: z.boolean().default(false),
  proofNotApplicable: z.boolean().default(false),
  proofGazetteNameChange: z.boolean().default(false),
  proofGazetteFatherName: z.boolean().default(false),
