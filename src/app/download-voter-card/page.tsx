      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">
            Voter Card Download Lists
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Review, search, and manage voter card download requests in one
            place.
          </p>
        </div>
        <Button
          className="px-6"
          onClick={() => navigate("/download-voter-card/add")}
        >
          Add Voter Card
        </Button>
      </div>
