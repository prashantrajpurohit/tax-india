...
const schema = z.object({
  ...
  proofPanCard: z.boolean(),
  proofOldItrCopy: z.boolean(),
  proofForm16: z.boolean(),
  proofOthers: z.boolean(),
  proofAadhaarCard: z.boolean(),
  proof80cDoc: z.boolean(),
  proofJForm: z.boolean(),
      ...
      <div className="space-y-2">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link to="/itr-application">ITR Application</Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Fill out the details to create a new ITR application.
            </p>
          </div>
        </div>
      </div>
