...
const schema = z.object({
  ...
  changeName: z.boolean(),
  changeGender: z.boolean(),
  changeDob: z.boolean(),
  changeFatherName: z.boolean(),
  changeMobile: z.boolean(),
  changeAddress: z.boolean(),
      ...
      <div className="space-y-2">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink asChild>
                <Link to="/aadhar-change">Aadhaar Change</Link>
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Provide details for Aadhaar corrections and document uploads.
            </p>
          </div>
        </div>
      </div>
